    ...
    <div className='about-me-page'>
      <div className='about-me'>
        <img 
            className='selfieIMG'
            src={SELFIE} 
            alt='Black and white selfie image of webpage creator' 
        />
        <p>
