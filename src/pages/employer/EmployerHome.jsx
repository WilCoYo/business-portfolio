    ...
    <div className='about-me-page'>
      <div className='about-me'>
        ...
        <p>
          ...
          <br></br><br></br>I am comfortable working with JavaScript, HTML, CSS, React, Node.js, and Express.js, MongoDB, and I have knowledge of Python—making me well-prepared to contribute to any type of development efforts. Additionally, my experience in remote team coordination during my time with PICS iTech and AmeriCorps has prepared me for success in any work environment, including remote-first.
        </p>
      </div>
      < Navigation />
